 ...
 * @version $Id: RSAUtils.java v 0.1 2017/1/9 17:38 luyb Exp $$
 */
public class RSAUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String encryptPwd = encrypt(arr[0], password);
        System.out.println("encrypted password:" + encryptPwd);
        System.out.println("decrypted password:" + decrypt(arr[1], encryptPwd));
